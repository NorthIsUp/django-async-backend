...
class QuerySet(AltersData):
        ...
        **kwargs: Any,
        ...
        async with async_atomic(using=self.db):
            ...
            if concrete_field_names.issuperset(update_fields):
                ...
                # fields. This is to maintain backward compatibility as
                # these fields are not updated unless explicitly specified
                # in the update_fields list.
    ...
    async def abulk_update(
        ...
        requires_casting = (
            connection.features.requires_casted_case_in_updates
        )
        batches = (
            objs[i : i + batch_size]
        ...
        async with async_atomic(using=self.db, savepoint=False):
            for pks, update_kwargs in updates:
                rows_updated += await queryset.filter(
                    pk__in=pks
    ...
    def alias(self, *args: Any, **kwargs: Any) -> "QuerySet":
        """
    ...
    def defer(self, *fields: str | None) -> "QuerySet":
        """
